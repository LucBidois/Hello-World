...
def Cube_lines():
    ...
    for edge in edges:
        ...
        for vertex in edge:
            glVertex3fv(vertices[vertex]) #just wants a vertex then do what you specified you wanted with it (GL_LINES)
    glEnd()
...
def main():
    ...
    glTranslatef(0.0, 2.0, -20) # position of cube object (x, y, z)
